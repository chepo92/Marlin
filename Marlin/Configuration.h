...
#define STRING_CONFIG_H_AUTHOR "(Christian Riede, Mendel90 Kraken)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ramps VIKI"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like http://www.uuidgenerator.net/version4
#define MACHINE_UUID "db9475a7-27d0-4fc8-9f1e-6cedd057dc13"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Mendel 90 Kraken
  #define DEFAULT_bedKp 77.10
  #define DEFAULT_bedKi 12.89
  #define DEFAULT_bedKd 307.36
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { (200*16)/(20*2), (200*16)/(20*2), (200*16)/1.5, (200*16)/(7 * 3.141)*(50.0/44.15)}
//*50/(95.97-66.29)*50.0/29.91 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 30000, 30000, 100, 10000 }
