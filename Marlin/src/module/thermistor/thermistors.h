...
#endif
#if ANY_THERMISTOR_IS(22)  // By AluOne https://github.com/MarlinFirmware/Marlin/issues/12622 21 has been taken so renumbered to 22
  #include "thermistor_22.h"  
#endif
#if ANY_THERMISTOR_IS(23)  // By AluOne https://github.com/MarlinFirmware/Marlin/issues/12622  22 renumbered to 23
